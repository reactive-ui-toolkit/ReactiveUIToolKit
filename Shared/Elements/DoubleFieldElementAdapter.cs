...
{
    public sealed class DoubleFieldElementAdapter : BaseElementAdapter
    {
        public override VisualElement Create() => new DoubleField();
        ...
        {
            if (element is not DoubleField field || properties == null)
            {
                PropsApplier.Apply(element, properties);
                return;
            }
            TryApplyProp<double>(properties, "value", v => field.value = v);
        ...
        {
            if (element is not DoubleField field)
            {
            ...
            next ??= s_emptyProps;
            TryDiffProp<double>(previous, next, "value", v => field.value = v);
