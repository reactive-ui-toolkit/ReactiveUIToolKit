...
{
    public sealed class LongFieldElementAdapter : BaseElementAdapter
    {
        ...
        )
        {
            ...
            TryApplyProp<long>(properties, "value", v => field.value = v);
        ...
        )
        {
            ...
            next ??= s_emptyProps;
            TryDiffProp<long>(previous, next, "value", v => field.value = v);
        ...
        {
            if (element is LongField field && props is LongFieldProps fp)
            {
        ...
        {
            if (
                element is LongField field
                && prev is LongFieldProps fp
                && next is LongFieldProps fn
            )
            {
