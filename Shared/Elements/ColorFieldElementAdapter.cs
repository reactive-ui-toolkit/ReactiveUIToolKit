...
namespace Ruitk.Elements
{
    ...
    {
        public override VisualElement Create() => new ColorField();
        ...
        {
            if (element is not ColorField field || properties == null)
            {
                PropsApplier.Apply(element, properties);
                return;
            }
            TryApplyProp<Color>(properties, "value", v => field.value = v);
        ...
        {
            if (element is not ColorField field)
            {
            ...
            next ??= s_emptyProps;
            TryDiffProp<Color>(previous, next, "value", v => field.value = v);
        ...
        {
            if (element is ColorField field && props is ColorFieldProps fp)
            {
        ...
        {
            if (
                element is ColorField field
                && prev is ColorFieldProps fp
                && next is ColorFieldProps fn
            )
            {
