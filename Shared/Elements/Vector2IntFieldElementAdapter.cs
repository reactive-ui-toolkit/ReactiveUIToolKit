...
namespace Ruitk.Elements
{
    public sealed class Vector2IntFieldElementAdapter : BaseElementAdapter
    {
        ...
        {
            if (element is Vector2IntField field && props is Vector2IntFieldProps fp)
            {
        ...
        {
            if (
                element is Vector2IntField field
                && prev is Vector2IntFieldProps fp
                && next is Vector2IntFieldProps fn
            )
            {
