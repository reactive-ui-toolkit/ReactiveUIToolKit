...
{
    public sealed class FloatFieldElementAdapter : BaseElementAdapter
    {
        ...
        {
            if (element is not FloatField field || properties == null)
            {
                PropsApplier.Apply(element, properties);
                return;
            }

            TryApplyProp<float>(properties, "value", v => field.value = v);
        ...
        )
        {
            ...
            TryDiffProp<float>(previous, next, "value", v => field.value = v);
        ...
        {
            if (element is FloatField field && props is FloatFieldProps fp)
            {
        ...
        {
            if (
                element is FloatField field
                && prev is FloatFieldProps fp
                && next is FloatFieldProps fn
            )
            {
