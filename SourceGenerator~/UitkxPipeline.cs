...
namespace ReactiveUITK.SourceGenerator
{
    ...
    public static class UitkxPipeline
    {
        ...
        )
        {
            ...
            // New-mode files (ES-modules campaign, U-02): a component body must see its own file's
